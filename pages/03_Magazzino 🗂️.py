...
if True:
	...
	for doc in docs:
		...
		prodotti_dict = {"Nome": doc.to_dict()['nome'], "Annata": doc.to_dict()['annata'], "Quantità": quant, "Prezzo privato" : doc.to_dict()['prezzo_vp'], "Prezzo grossista" : doc.to_dict()['prezzo_vg'], "Prezzo di acquisto" : doc.to_dict()['prezzo_a']} 
